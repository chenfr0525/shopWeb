<script setup>
import { getCheckoutService, addAddressService, delAddressService, createOrderService } from '@/api/checkout'
...
const rules = {
  receiver: [
    ...
    { min: 2, message: '长度大于2', trigger: 'blur' },
  ],
  contact: [
...
const addConfirm = async () => {
  await addAddressService(addressForm.value)
...
<template>
  ...
  <el-dialog v-model="addFlag" title="添加收货地址" width="30%" center>
    <div class="addressWrapper">
      <el-form :rules="rules" ref="FormRef" :model="addressForm" label-position="right" label-width="100px">
        <el-form-item label="收货人：" prop="receiver">
          <el-input v-model="addressForm.receiver" placeholder="请输入收货人"></el-input>
        </el-form-item>
        <el-form-item label="电话号码：" prop="contact">
          <el-input v-model="addressForm.contact" placeholder="请输入电话号码"></el-input>
        </el-form-item>
        <el-form-item label="地址：" prop="address">
          <el-input v-model="addressForm.address" placeholder="请输入地址"></el-input>
        </el-form-item>
        <el-form-item label="地址标签：" prop="addressTags">
          <el-input v-model="addressForm.addressTags" placeholder="请输入地址标签"></el-input>
        </el-form-item>
        <el-form-item label="详细地址：" prop="fullLocation">
          <el-input v-model="addressForm.fullLocation" placeholder="请输入详细地址"></el-input>
        </el-form-item>
      </el-form>
    </div>
    <template #footer>
